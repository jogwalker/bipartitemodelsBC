...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/phase4/cijk.txt"))     
...
## Run model
output  <- jags(long, inits = inits, c('mn', 'sd', 'use', 'HB_invert', 'PD_host', 'beta', 'alpha','alpha_r','alpha_d','alpha_b','alpha_m','prec_beta'), modelfile, n.chains=3, n.iter=iter) # or use defaults
