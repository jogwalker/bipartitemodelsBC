...
save(long,file=paste(outdir,"/iklong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/phase4/ik.txt"))     
...
save(output, file = paste(outdir,"/ik_output.RData",sep=""))
...
sink(file=paste(outdir,"/ik_printoutput.txt",sep=""))
