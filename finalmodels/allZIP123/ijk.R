...
save(long,file=paste(outdir,"/ijklong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/ijk.txt"))     
...
save(output, file = paste(outdir,"/ijk_output.RData",sep=""))
...
sink(file=paste(outdir,"/ijk_printoutput.txt",sep=""))
