...
save(long,file=paste(outdir,"/lilong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/li.txt"))   
...
save(output, file = paste(outdir,"/li_output.RData",sep=""))
...
sink(file=paste(outdir,"/li_printoutput.txt",sep=""))
