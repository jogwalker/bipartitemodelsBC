...
modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/betaFull/m1o.txt" 
...
## Run model
output  <- jags(long, inits = inits, c('mn', 'sd', 'use','beta','alpha','r','HB_invert','PD_host','hosts','phi','beta_j'), modelfile, n.chains=3, n.iter=iter,n.burnin=burnin,n.thin=thin) # or use defaults
