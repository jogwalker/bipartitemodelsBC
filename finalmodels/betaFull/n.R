...
## Run model
output  <- jags(long, inits = inits, c('mn', 'sd', 'use','beta','alpha','r','HB_invert','PD_host','hosts','phi','beta_t'), modelfile, n.chains=3, n.iter=iter,n.burnin=burnin,n.thin=thin) # or use defaults
