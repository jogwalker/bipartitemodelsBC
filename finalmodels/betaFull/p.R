...
modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/betaFull/m1p.txt"   
...
### Run model
output  <- jags(long, inits = inits, c('mn', 'sd', 'use', 'phi','beta','alpha','r','HB_invert','PD_host','hosts','beta_s'), modelfile, n.chains=3, n.iter=iter,n.burnin=burnin,n.thin=thin) # or use defaults
