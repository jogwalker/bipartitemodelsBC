...
save(long,file=paste(outdir,"/cnjlong_mat.RData",sep=""))

## Define model


modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/final/cnj.txt"     
...
save(output, file = paste(outdir,"/cnj_output_mat.RData",sep=""))
...
sink(file=paste(outdir,"/cnj_printoutput_mat.txt",sep=""))
