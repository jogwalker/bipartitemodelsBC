...
save(long,file=paste(outdir,"/cnjlong-trunc",iter,".RData",sep=""))
...
save(output, file = paste(outdir,"/cnj_output-trunc",iter,".RData",sep=""))
...
sink(file=paste(outdir,"/cnj_printoutput-trunc",iter,".txt",sep=""))
