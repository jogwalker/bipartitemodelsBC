...
modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/betaT/m1j.txt"  
...
## Run model
output  <- jags(long, inits = inits, c('mn', 'sd', 'use','phi','mu','alpha_cov'), modelfile, n.chains=3, n.iter=iter,n.burnin=burnin,n.thin=thin) # or use defaults
