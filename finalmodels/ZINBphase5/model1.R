...
save(long,file=paste(outdir,"/M1long.RData",sep=""))

## Define model


modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/phase5/m1.txt"    
...
save(output, file = paste(outdir,"/M1output.RData",sep=""))
...
sink(file=paste(outdir,"/M1printoutput.txt",sep=""))
