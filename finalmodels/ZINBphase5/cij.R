...
modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/phase5/cij.txt"     
...
## Run model
output  <- jags(long, inits = inits, c('mn', 'sd', 'use', 'HB_invert', 'PD_host', 'beta', 'alpha','alpha_r','alpha_d','prec.beta','r'), modelfile, n.chains=3, n.iter=iter) # or use defaults
