...
modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/phase5/clxn.txt"   
...
## Run model
output  <- jags(long, inits = inits, c('mn', 'sd', 'use', 'HB_invert', 'PD_host', 'beta','beta_pr','alpha','beta_t','prec.beta','r'), modelfile, n.chains=3, n.iter=iter) # or use defaults
