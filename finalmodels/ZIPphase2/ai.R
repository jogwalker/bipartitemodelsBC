...
save(long,file=paste(outdir,"/ailong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/ai.txt"))    
...
save(output, file = paste(outdir,"/ai_output.RData",sep=""))
...
sink(file=paste(outdir,"/ai_printoutput.txt",sep=""))
