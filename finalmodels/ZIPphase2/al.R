...
save(long,file=paste(outdir,"/allong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/al.txt"))    
...
save(output, file = paste(outdir,"/al_output.RData",sep=""))
...
sink(file=paste(outdir,"/al_printoutput.txt",sep=""))
