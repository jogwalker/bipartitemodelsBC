...
save(long,file=paste(outdir,"/cnjlongwild.RData",sep=""))
...
save(output, file = paste(outdir,"/cnj_outputwild.RData",sep=""))
...
sink(file=paste(outdir,"/cnj_printoutputwild.txt",sep=""))
