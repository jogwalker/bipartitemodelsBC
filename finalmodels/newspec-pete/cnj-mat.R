...
save(long,file=paste(outdir,"/cnjlong_mat",iter,".RData",sep=""))

## Define model


modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/newspec-pete/cnj-mat.txt"     
...
save(output, file = paste(outdir,"/cnj_output_mat",iter,".RData",sep=""))
...
sink(file=paste(outdir,"/cnj_printoutput_mat",iter,".txt",sep=""))
