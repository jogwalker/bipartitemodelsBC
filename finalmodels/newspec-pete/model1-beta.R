...
save(long,file=paste(outdir,"/M1long",iter,".RData",sep=""))


## Define model


modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/newspec-pete/m1.txt"    
...
save(output, file = paste(outdir,"/M1_output",iter,".RData",sep=""))
...
sink(file=paste(outdir,"/M1printoutput",iter,".txt",sep=""))
