...
save(long,file=paste(outdir,"/cnjlong",iter,".RData",sep=""))


## Define model


modelfile <- "~/bipartitemodelsBC/finalmodels/jagsNB/newspec-pete/cnj.txt"     
...
save(output, file = paste(outdir,"/cnj_output",iter,".RData",sep=""))
...
sink(file=paste(outdir,"/cnj_printoutput",iter,".txt",sep=""))
