...
save(long,file=paste(outdir,"/M1clong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/m1c.txt")) 
...
save(output, file = paste(outdir,"/M1coutput.RData",sep=""))
...
sink(file=paste(outdir,"/M1cprintoutput.txt",sep=""))
