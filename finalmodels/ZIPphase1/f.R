...
save(long,file=paste(outdir,"/M1flong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/m1f.txt"))    
...
save(output, file = paste(outdir,"/M1foutput.RData",sep=""))
...
sink(file=paste(outdir,"/M1fprintoutput.txt",sep=""))
