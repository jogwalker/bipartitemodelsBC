...
save(long,file=paste(outdir,"/M1hlong.RData",sep=""))
...
} '    , file=(modelfile <- "~/bipartitemodelsBC/finalmodels/jags/m1h.txt"))    
...
save(output, file = paste(outdir,"/M1houtput.RData",sep=""))
...
sink(file=paste(outdir,"/M1hprintoutput.txt",sep=""))
