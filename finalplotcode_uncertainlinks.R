...
agg$host_sp <- gsub("_"," " ,agg$host.sp)
agg$par_sp <- gsub("_"," " ,agg$par.sp)
...
pdf("~/dat/bipartitemodelsBC/phil trans revision/host-pardiv.pdf")
...
# pdf("~/dat/bipartitemodelsBC/phil trans revision/par-hostbr.pdf",height=11)
